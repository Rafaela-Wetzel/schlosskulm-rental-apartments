...
class Booking(models.Model):
    ...
    birth_date = models.DateField(help_text = "Please enter data in the format '2006-10-25'", validators=[])
    ...
    arrival_date = models.DateField(help_text = "Please enter data in the format '2006-10-25'", validators=[])
    departure_date = models.DateField(help_text = "Please enter data in the format '2006-10-25'", validators=[])
    guest_number = (
        ('1', '1'),
        ('2', '2'), 
        ('3', '3'), 
    ...
    def clean(self):
        ...
        elif arrival_date or departure_date < datetime.date.today():
